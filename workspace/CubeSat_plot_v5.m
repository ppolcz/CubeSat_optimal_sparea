...
Logger.latexify_axis(Axes_fontSize)
...
title(sprintf('Simulated $T_{\\mathrm{T}}(t) \\in [%g,%g]\\, \\mathrm{K}$ ($\\lambda \\!=\\! %g$), %s.', ...
    round(Sim_Min,2), round(Sim_Max,2),round(lambda,4),ou),...
    'Interpreter', 'LaTeX', 'FontSize', Title_fontSize-0.5)
